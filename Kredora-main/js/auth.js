          ...
          slot.innerHTML = `
            <div class="flex items-center gap-3">
              ...
              <div class="relative group">
                <button type="button" class="flex items-center gap-2 py-1 px-2.5 rounded-full bg-white/5 border border-white/10 backdrop-blur-md hover:border-gold/50 transition-colors" id="user-menu-btn" aria-haspopup="true">
                ...
                <div class="absolute right-0 mt-2 w-48 rounded-xl border border-white/10 bg-[#131a2b]/90 backdrop-blur-xl shadow-2xl py-1 text-sm hidden group-hover:block hover:block z-50">
